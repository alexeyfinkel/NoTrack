...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring( 'file:/local/cms/user/gude/2012_single_electron_skim/2012A_Single_Electron_Trigger_Skim/2012A_Single_Electron_Trigger_Skim_003.root')
)
