...
process.GlobalTag.globaltag = 'FT_R_53_V21::All' #this is supposed to be for 2012 A-C
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring( 'file:/local/cms/phedex/store/data/Run2012A/DoubleElectron/AOD/22Jan2013-v1/20000/0045FFC7-6167-E211-9247-003048678B34.root')
)
