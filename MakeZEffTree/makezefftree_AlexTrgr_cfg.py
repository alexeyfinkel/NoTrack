...
process.GlobalTag.globaltag = 'FT_R_53_V18::All' #this is supposed to be for MC
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring( '/store/data/Run2012A/DoubleElectron/AOD/22Jan2013-v1/20000/CCB5BA42-8067-E211-B915-0026189438B1.root')
)
