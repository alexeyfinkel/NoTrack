...
int crystalCalibPileupDepDat()
{
	...
	for(int b=0;b<4;b++)
	{
		for(int r=0;r<7;r++)
		{
			...
			if(meanByEtaP[b][r]->Integral() > 10)
			{
				...
				ringAverageMeansP[b]->SetBinError(r+1,meanByEtaP[b][r]->GetMeanError(1));
			}
			if(meanByEtaN[b][r]->Integral() > 10)
			{
				...
				ringAverageMeansN[b]->SetBinError(r+1,meanByEtaN[b][r]->GetMeanError(1));
			}
		}
	}
	...
	for(int b=1;b<3;b++)
	{
		...
		ringAveragePeaksP[b]->SetMarkerSize(2);
		l1->AddEntry(ringAveragePeaksP[b],legend);
		ringAveragePeaksP[b]->Draw("same P");
	}
	l1->Draw();
	c1->Print("Efficiencies/CrystalCalibPileupDep_Data/RingAveragePeaksVsEtaP.png");
	c1->Clear();
	l1->Clear();
	...
	for(int b=1;b<3;b++)
	{
		...
		ringAveragePeaksN[b]->SetMarkerSize(2);
		l1->AddEntry(ringAveragePeaksN[b],legend);
		ringAveragePeaksN[b]->Draw("same P");
	}
	l1->Draw();
	c1->Print("Efficiencies/CrystalCalibPileupDep_Data/RingAveragePeaksVsEtaN.png");
	c1->Clear();
	l1->Clear();
	...
	ringAverageMeansP[0]->SetMarkerSize(2);
	ringAverageMeansP[0]->GetYaxis()->SetRangeUser(0.6,1.2);
	l1->AddEntry(ringAverageMeansP[0],legend);
	ringAverageMeansP[0]->Draw("P");
	for(int b=1;b<3;b++)
	{
		marker++;
		color--;
		...
		ringAverageMeansP[b]->SetMarkerSize(2);
		l1->AddEntry(ringAverageMeansP[b],legend);
		ringAverageMeansP[b]->Draw("same P");
	}
	l1->Draw();
	c1->Print("Efficiencies/CrystalCalibPileupDep_Data/RingAverageMeansVsEtaP.png");
	c1->Clear();
	l1->Clear();
	...
	ringAverageMeansN[0]->SetMarkerSize(2);
	ringAverageMeansN[0]->GetYaxis()->SetRangeUser(0.6,1.2);
	l1->AddEntry(ringAverageMeansN[0],legend);
	ringAverageMeansN[0]->Draw("P");
	for(int b=1;b<3;b++)
	{
		marker++;
		color--;
		...
		ringAverageMeansN[b]->SetMarkerSize(2);
		l1->AddEntry(ringAverageMeansN[b],legend);
		ringAverageMeansN[b]->Draw("same P");
	}
	l1->Draw();
	c1->Print("Efficiencies/CrystalCalibPileupDep_Data/RingAverageMeansVsEtaN.png");
	c1->Clear();
	l1->Clear();
